...
public class CheckMainMenuTest extends BaseScript {
    ...
    public static void printTitleAndRefreshWithClassName(String locator, WebDriver driver, String locatorsTitle, String headersText, String titlesText) throws InterruptedException {
        WebElement webElementName = driver.findElement(By.xpath(locator));
        webElementName.click();
        WebElement headersName = driver.findElement(By.className(locatorsTitle));
        System.out.println(headersName.getText());
        driver.navigate().refresh();
        headersName = driver.findElement(By.className(locatorsTitle));
        assertTrue(headersName.getText().contains(headersText));//for pages title
        assertTrue(driver.getTitle().contains(titlesText)); //для крупного заголовка на странице
    }

    public static void printTitleAndRefreshWithXPath(String locator, WebDriver driver, String locatorsTitle, String headersText, String titlesText) throws InterruptedException {
        WebElement webElementName = driver.findElement(By.xpath(locator));
        webElementName.click();
        WebElement headersName = driver.findElement(By.xpath(locatorsTitle));
        System.out.println(headersName.getText());
        driver.navigate().refresh();
        headersName = driver.findElement(By.xpath(locatorsTitle));
